...
Begin analysis with qualitative and quantitative tests for the coins we've selected. In general, we are interested in basic characteristics of our time series. 
...
We will generally deal with the log transform because this transformation will help us measure <b> relative change </b> in coin prices. Given that cryptocoins trade at radically different prices, their aboslute linear price change will be hard to compare, so we take the log of pricing data. The same is generally true for volume.
